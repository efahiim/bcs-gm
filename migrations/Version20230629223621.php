 ...
 */
final class Version20230629223621 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `order` ADD total DOUBLE PRECISION NOT NULL, CHANGE status status ENUM(\'Paid\', \'Delivered\')');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `order` DROP total, CHANGE status status VARCHAR(255) DEFAULT NULL');
