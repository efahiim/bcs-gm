 ...
 */
final class Version20230630203304 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `order` ADD total DOUBLE PRECISION NOT NULL, CHANGE status status ENUM(\'Cart\', \'Paid\')');
